...
class Dashboard extends BaseController
{
    ...
    public function setPages(){
        $this->pages = [
            [
                ...
                'menu_title' => 'MRL Radio Rock',
                'capability' => 'manage_options',
                'menu_slug' => 'mrl_radio_rock_plugin',
    ...
    public function setSettings(){
            ...
            $args = [
                [ 'option_group' => 'mrl_radio_rock_plugin_settings',                  //représente l'id du groupe d'option
                'option_name' => 'mrl_radio_rock_plugin',                              //représente l'id de l'option
    ...
    public function setSections(){
        $args = [
            [
                ...
                'page' => 'mrl_radio_rock_plugin'                                      //Slug de la page dans laquelle les checkbox seront affiché
            ]
            ];
    ...
    public function setFields(){
        ...
        foreach ( $this->managers_admin as $key => $value) {
            $args[] = [
                ...
                'page' => 'mrl_radio_rock_plugin',
                'section' => 'mrl_admin_index',
                'args' => [
                    [
                        'option_name' => 'mrl_radio_rock_plugin',
                        'label_for' => $key,
    ...
    public function register(){
        ...
        $this->settings->addPages( $this->pages )->subPage('Gestion de Radio Rock')->register();
    }
}